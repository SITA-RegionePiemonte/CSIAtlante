...
from PyQt4.QtCore import QUrl, QSettings, Qt, QIODevice, QXmlStreamWriter, QXmlStreamReader, QFile
...
class CsiAtlanteDialog(QtGui.QDockWidget):
    """
...
#         self.ui.tabWidget.setCurrentIndex(indexTabDefault)
    ...
    def disconnect(self):
        ...
        disconnect
        """
        QtCore.QObject.disconnect(self.ui.tabWidget, QtCore.SIGNAL("currentChanged ( int )"), self.activateTab)
...
class GestoreTabObject(object):
    ...
    def connect(self):
        ...
        if hasattr(self.tabObj, 'cboServiceConnections'):
            QtCore.QObject.connect(self.tabObj.cboServiceConnections, QtCore.SIGNAL("activated(int)"), self.selectedServiceConnections)
        if hasattr(self.tabObj, 'cboServiceConnections'):
            QtCore.QObject.connect(self.tabObj.cboServiceConnections, QtCore.SIGNAL("currentIndexChanged(int)"), self.changedServiceConnections)
        if hasattr(self.tabObj, 'btnAbout'):
            QtCore.QObject.connect(self.tabObj.btnAbout, QtCore.SIGNAL("clicked()"), self.showAbout)
        if hasattr(self.tabObj, 'btnServiceNew'):
            QtCore.QObject.connect(self.tabObj.btnServiceNew, QtCore.SIGNAL("clicked()"), self.newServiceConnection)
        if hasattr(self.tabObj, 'btnServiceEdit'):
            QtCore.QObject.connect(self.tabObj.btnServiceEdit, QtCore.SIGNAL("clicked()"), self.editServiceConnection)
        if hasattr(self.tabObj, 'btnServiceDelete'):
            QtCore.QObject.connect(self.tabObj.btnServiceDelete, QtCore.SIGNAL("clicked()"), self.deleteServiceConnection)
        if hasattr(self.tabObj, 'btnServiceLoadFile'):
            QtCore.QObject.connect(self.tabObj.btnServiceLoadFile, QtCore.SIGNAL("clicked()"), self.importServiceConnections)
        if hasattr(self.tabObj, 'btnServiceSaveFile'):
            QtCore.QObject.connect(self.tabObj.btnServiceSaveFile, QtCore.SIGNAL("clicked()"), self.exportServiceConnections)
        if hasattr(self.tabObj, 'chkLocale'):
            QtCore.QObject.connect(self.tabObj.chkLocale, QtCore.SIGNAL("stateChanged(int)"), self.changeBehaviour)
#         if hasattr(self.tabObj, 'chkTabProgetti'):
#             QtCore.QObject.connect(self.tabObj.chkTabProgetti, QtCore.SIGNAL("stateChanged(int)"), self.changeStateTabProgetti)
#         if hasattr(self.tabObj, 'chkTabPostgis'):
#             QtCore.QObject.connect(self.tabObj.chkTabPostgis, QtCore.SIGNAL("stateChanged(int)"), self.changeStateTabPostgis)
#         if hasattr(self.tabObj, 'chkTabRaster'):
#             QtCore.QObject.connect(self.tabObj.chkTabRaster, QtCore.SIGNAL("stateChanged(int)"), self.changeStateTabRaster)
#         if hasattr(self.tabObj, 'chkTabWMS'):
#             QtCore.QObject.connect(self.tabObj.chkTabWMS, QtCore.SIGNAL("stateChanged(int)"), self.changeStateTabWMS)
#         if hasattr(self.tabObj, 'chkTabCSW'):
#             QtCore.QObject.connect(self.tabObj.chkTabCSW, QtCore.SIGNAL("stateChanged(int)"), self.changeStateTabCSW)
#         if hasattr(self.tabObj, 'chkTabIndica'):
#             QtCore.QObject.connect(self.tabObj.chkTabIndica, QtCore.SIGNAL("stateChanged(int)"), self.changeStateTabIndica)
        if hasattr(self.tabObj, 'cboConnections'):
            QtCore.QObject.connect(self.tabObj.cboConnections, QtCore.SIGNAL("activated(int)"), self.selectedConnections)
        if hasattr(self.tabObj, 'btnNew'):
            QtCore.QObject.connect(self.tabObj.btnNew, QtCore.SIGNAL("clicked()"), self.newConnection)
        if hasattr(self.tabObj, 'btnEdit'):
            QtCore.QObject.connect(self.tabObj.btnEdit, QtCore.SIGNAL("clicked()"), self.editConnection)
        if hasattr(self.tabObj, 'btnDelete'):
            QtCore.QObject.connect(self.tabObj.btnDelete, QtCore.SIGNAL("clicked()"), self.deleteConnection)
        if hasattr(self.tabObj, 'btnLoadFile'):
            QtCore.QObject.connect(self.tabObj.btnLoadFile, QtCore.SIGNAL("clicked()"), self.importConnections)
        if hasattr(self.tabObj, 'btnSaveFile'):
            QtCore.QObject.connect(self.tabObj.btnSaveFile, QtCore.SIGNAL("clicked()"), self.exportConnections)
        ...
        if hasattr(self.tabObj, 'treeWidget'):
            ...
            # NEW STYLE TODO self.tabObj.treeWidget.itemClicked[QTreeWidgetItem*, int].connect(self.__tree_itemClicked)

        if hasattr(self.tabObj, 'cboCategory'):
            QtCore.QObject.connect(self.tabObj.cboCategory, QtCore.SIGNAL("currentIndexChanged(int)"), self.categoryChanged)
        if hasattr(self.tabObj, 'cboUnita'):
            QtCore.QObject.connect(self.tabObj.cboUnita, QtCore.SIGNAL("currentIndexChanged(int)"), self.unitaChanged)
        if hasattr(self.tabObj, 'cboPeriodicita'):
            QtCore.QObject.connect(self.tabObj.cboPeriodicita, QtCore.SIGNAL("currentIndexChanged(int)"), self.periodicitaChanged)
#         if hasattr(self.tabObj, 'btSerieStorica'):
#             QtCore.QObject.connect(self.tabObj.btSerieStorica, QtCore.SIGNAL("clicked()"), self.graficiSerieStorica)
        if hasattr(self.tabObj, 'btCerca'):
            QtCore.QObject.connect(self.tabObj.btCerca, QtCore.SIGNAL("released ()"), self.__filterChanged)
        if hasattr(self.tabObj, 'btApriAlbero'):
            QtCore.QObject.connect(self.tabObj.btApriAlbero, QtCore.SIGNAL("clicked()"), self.__onApriAlbero)
        if hasattr(self.tabObj, 'btDeseleziona'):
            QtCore.QObject.connect(self.tabObj.btDeseleziona, QtCore.SIGNAL("clicked()"), self.__onDeselezionaAlbero)
        if hasattr(self.tabObj, 'btChiudiAlbero'):
            QtCore.QObject.connect(self.tabObj.btChiudiAlbero, QtCore.SIGNAL("clicked()"), self.__onChiudiAlbero)
        if hasattr(self.tabObj, 'btMetadati'):
            QtCore.QObject.connect(self.tabObj.btMetadati, QtCore.SIGNAL("clicked()"), self.__onMetadati)
        if hasattr(self.tabObj, 'ckSerieStorica'):
            QtCore.QObject.connect(self.tabObj.ckSerieStorica, QtCore.SIGNAL("stateChanged(int)"), self.changeStateSerieStorica)
    ...
    def disconnect(self):
        # altri tab
        if hasattr(self.tabObj, 'treeWidget'):
            QtCore.QObject.disconnect(self.tabObj.treeWidget, QtCore.SIGNAL("itemClicked(QTreeWidgetItem*,int)"), self.__tree_itemClicked)
        if hasattr(self.tabObj, 'cboCategory'):
            QtCore.QObject.disconnect(self.tabObj.cboCategory, QtCore.SIGNAL("currentIndexChanged(int)"), self.categoryChanged)
        if hasattr(self.tabObj, 'cboUnita'):
            QtCore.QObject.disconnect(self.tabObj.cboUnita, QtCore.SIGNAL("currentIndexChanged(int)"), self.unitaChanged)
        if hasattr(self.tabObj, 'cboPeriodicita'):
            QtCore.QObject.disconnect(self.tabObj.cboPeriodicita, QtCore.SIGNAL("currentIndexChanged(int)"), self.periodicitaChanged)
#         if hasattr(self.tabObj, 'btSerieStorica'):
#             QtCore.QObject.disconnect(self.tabObj.btSerieStorica, QtCore.SIGNAL("clicked()"), self.graficiSerieStorica)
        if hasattr(self.tabObj, 'btCerca'):
            QtCore.QObject.disconnect(self.tabObj.btCerca, QtCore.SIGNAL("released ()"), self.__filterChanged)
        if hasattr(self.tabObj, 'btApriAlbero'):
            QtCore.QObject.disconnect(self.tabObj.btApriAlbero, QtCore.SIGNAL("clicked()"), self.__onApriAlbero)
        if hasattr(self.tabObj, 'btDeseleziona'):
            QtCore.QObject.disconnect(self.tabObj.btDeseleziona, QtCore.SIGNAL("clicked()"), self.__onDeselezionaAlbero)
        if hasattr(self.tabObj, 'btChiudiAlbero'):
            QtCore.QObject.disconnect(self.tabObj.btChiudiAlbero, QtCore.SIGNAL("clicked()"), self.__onChiudiAlbero)
        if hasattr(self.tabObj, 'btMetadati'):
            QtCore.QObject.disconnect(self.tabObj.btMetadati, QtCore.SIGNAL("clicked()"), self.__onMetadati)
        if hasattr(self.tabObj, 'ckSerieStorica'):
            QtCore.QObject.disconnect(self.tabObj.ckSerieStorica, QtCore.SIGNAL("stateChanged(int)"), self.changeStateSerieStorica)

        # tab di configurazione
        if hasattr(self.tabObj, 'btnAbout'):
            QtCore.QObject.disconnect(self.tabObj.btnAbout, QtCore.SIGNAL("clicked()"), self.showAbout)
        if hasattr(self.tabObj, 'cboServiceConnections'):
            QtCore.QObject.disconnect(self.tabObj.cboServiceConnections, QtCore.SIGNAL("activated( int )"), self.selectedServiceConnections)
        if hasattr(self.tabObj, 'cboServiceConnections'):
            QtCore.QObject.disconnect(self.tabObj.cboServiceConnections, QtCore.SIGNAL("currentIndexChanged(int)"), self.changedServiceConnections)
        if hasattr(self.tabObj, 'btnServiceNew'):
            QtCore.QObject.disconnect(self.tabObj.btnServiceNew, QtCore.SIGNAL("clicked()"), self.newServiceConnection)
        if hasattr(self.tabObj, 'btnServiceEdit'):
            QtCore.QObject.disconnect(self.tabObj.btnServiceEdit, QtCore.SIGNAL("clicked()"), self.editServiceConnection)
        if hasattr(self.tabObj, 'btnServiceDelete'):
            QtCore.QObject.disconnect(self.tabObj.btnServiceDelete, QtCore.SIGNAL("clicked()"), self.deleteServiceConnection)
        if hasattr(self.tabObj, 'btnServiceLoadFile'):
            QtCore.QObject.disconnect(self.tabObj.btnServiceLoadFile, QtCore.SIGNAL("clicked()"), self.importServiceConnections)
        if hasattr(self.tabObj, 'btnServiceSaveFile'):
            QtCore.QObject.disconnect(self.tabObj.btnServiceSaveFile, QtCore.SIGNAL("clicked()"), self.exportServiceConnections)
        if hasattr(self.tabObj, 'chkLocale'):
            QtCore.QObject.disconnect(self.tabObj.chkLocale, QtCore.SIGNAL("stateChanged(int)"), self.changeBehaviour)
#         if hasattr(self.tabObj, 'chkTabProgetti'):
#             QtCore.QObject.disconnect(self.tabObj.chkTabProgetti, QtCore.SIGNAL("stateChanged(int)"), self.changeStateTabProgetti)
#         if hasattr(self.tabObj, 'chkTabPostgis'):
#             QtCore.QObject.disconnect(self.tabObj.chkTabPostgis, QtCore.SIGNAL("stateChanged(int)"), self.changeStateTabPostgis)
#         if hasattr(self.tabObj, 'chkTabRaster'):
#             QtCore.QObject.disconnect(self.tabObj.chkTabRaster, QtCore.SIGNAL("stateChanged(int)"), self.changeStateTabRaster)
#         if hasattr(self.tabObj, 'chkTabWMS'):
#             QtCore.QObject.disconnect(self.tabObj.chkTabWMS, QtCore.SIGNAL("stateChanged(int)"), self.changeStateTabWMS)
#         if hasattr(self.tabObj, 'chkTabCSW'):
#             QtCore.QObject.disconnect(self.tabObj.chkTabCSW, QtCore.SIGNAL("stateChanged(int)"), self.changeStateTabCSW)
#         if hasattr(self.tabObj, 'chkTabIndica'):
#             QtCore.QObject.disconnect(self.tabObj.chkTabIndica, QtCore.SIGNAL("stateChanged(int)"), self.changeStateTabIndica)
...
#                 raise (ValueError, "could not parse XML")
    ...
    def changeStateTabFromConf(self, dictConf):
        ...
        """
        for key, value in dictConf.iteritems():
